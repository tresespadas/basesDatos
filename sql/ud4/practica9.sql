...
CREATE DATABASE ventas CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE ventas;
...
-- Insert Data (ensure proper encoding)
...
/* Apartado 2 */
SELECT COUNT(pedido.id) AS Nº_pedidos_Daniel_Sáez_Vega
FROM pedido
...
WHERE pedido.cantidad=(
  SELECT MAX(pedido.cantidad)
  FROM pedido
  WHERE pedido.fecha LIKE '2019%'
);
