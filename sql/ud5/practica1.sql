...
INSERT INTO emple (emp_no, apellido, oficio, dir, fecha_alt, salario, comision, dept_no) 
VALUES
(9999,'GONZÁLEZ',NULL,NULL,NULL,NULL,NULL,10);
...
/* Apartado 6 */ -- DUDA: Datos? Dni? 3 columnas solo no coinciden y da error
...
INSERT INTO emple20 (emp_no, apellido, oficio, dir, fecha_alt, salario, comision, dept_no) 
SELECT emp_no, apellido, oficio, dir, fecha_alt, salario, comision, dept_no
FROM emple
WHERE dept_no=20;

/* Apartado 7 */ -- DUDA: Hacerlo en la tabla emple30?
UPDATE emple
...
/* Apartado 11 */ -- DUDA: Cuál actualizar emple30 o emple?
UPDATE emple
SET salario=(
  SELECT salario
  FROM emple30
